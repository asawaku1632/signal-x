  ...
  useEffect(() => {
    const fetchSignal = async () => {
      try {
        ...
        const rank =
          stocks.findIndex((item) => item.code === code) + 1;
  ...
  if (loading) {
    return (
      <main className="min-h-screen bg-black text-white p-4">
        <div className="max-w-md mx-auto">読み込み中...</div>
      </main>
    );
  }
      ...
      <div className="max-w-md mx-auto">
        <section className="rounded-3xl border border-orange-500/50 bg-zinc-950 p-5 mb-5">
          ...
          <div className="border-t border-zinc-800 pt-5">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <button
                onClick={addFavorite}
                className="bg-yellow-400 text-black font-black px-3 py-2 rounded-xl hover:scale-105 transition"
              >
                ⭐
              </button>
            </div>
            ...
            <div className="text-center mt-8">
              ...
              <p className="text-yellow-300 mt-2">
                成行100株（必要資金 {yen(signal.price * 100)}）
              </p>
            </div>
        ...
        <section className="rounded-3xl border border-purple-500/50 bg-zinc-950 p-5 mb-5 text-center">
          ...
          <p className="text-4xl font-black text-purple-300 mt-2">
            {historyStats &&
            historyStats.total >= 10 &&
            historyStats.winRate >= 70
              ? "得意銘柄"
              : historyStats &&
                historyStats.total >= 10 &&
                historyStats.winRate < 50
              ? "苦手銘柄"
              : "データ蓄積中"}
          </p>
        ...
        <section className="rounded-3xl border border-cyan-500/50 bg-zinc-950 p-5 mb-5">
          ...
          <a
            href="/top-signals"
            className="block rounded-2xl border border-orange-500/50 p-5 mt-4 text-center"
          >
        ...
        <section className="rounded-3xl border border-zinc-700 bg-zinc-950 p-5">
          ...
          <div className="mt-5 rounded-2xl border border-yellow-500/50 p-5">
            <p className="text-yellow-400 text-sm">AI評価</p>
